...
class PacmanImageFactory(object):
    ...
    def create(self):
        images = [
            ...
            self.sheet.get_image(49, 0, 13, 13),  # Lose
            self.sheet.get_image(64, 0, 15, 13),  # Lose
            self.sheet.get_image(80, 0, 15, 13),  # Lose
            self.sheet.get_image(96, 0, 15, 13),  # Lose
            self.sheet.get_image(112, 0, 15, 13),  # Lose
            self.sheet.get_image(128, 0, 15, 13),  # Lose
            self.sheet.get_image(144, 2, 15, 13),  # Lose
            self.sheet.get_image(160, 2, 15, 13),  # Lose
            self.sheet.get_image(176, 2, 13, 13),  # Lose
            self.sheet.get_image(192, 0, 13, 13),  # Lose
            self.sheet.get_image(208, 3, 13, 13),  # Lose
        ]
        for i in images:
